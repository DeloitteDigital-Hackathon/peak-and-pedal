...
## Environments
- Preview: https://main--peak-and-pedal--DeloitteDigital-Hackathon.aem.page/
- Live: https://main--peak-and-pedal--DeloitteDigital-Hackathon.aem.live/
...
1. Open the `peak-and-pedal` directory in your favorite IDE and start coding :)
